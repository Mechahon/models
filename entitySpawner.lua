...
return {
    createEntity=function(name)
        entityTable[name]={
            ...
            BreakLights=true,
            FlickerLenght=1,
            Model="https://github.com/Mechahon/models/blob/main/newestdepth.rbxm?raw=true",
            Height=5.0,
            Ambush={
                Enabled=false,
                MinCycles=1,
                MaxCycles=6,
                AmbienceMusic="https://github.com/Mechahon/models/blob/main/arrival.mp3?raw=true",
                WT_Increase=0.0,
                Speed_Increase=20
            },
